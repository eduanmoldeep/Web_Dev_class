...
<ul>
  ...
  <li><a href="generic.php">Cats</a></li>
  <li><a href="elements.php">Dog</a></li>
    <li class="dropdown">
...
<form name="form2" action="" method="post">
        ...
        <h1>Purchase Entry</h1>
          <fieldset>
          <legend><span class="number">5</span>Purchase</legend>
					<label>Pet ID :<span>*</span></label><br />
                    <input name="t15" type="text" placeholder="Enter pet id" required>
                    <br />
					<label>Customer ID :<span>*</span></label><br />
                    <input name="t16" type="text"  placeholder="Enter customer id" />
					 <br />
				<div align="center">	           
...
mysqli_query($link,"insert into puchase2 values('$_POST[t15]','$_POST[t16]')");
}
?>
    </body>
</html>